...
const HeroSection: React.FC<HeroSectionProps> = ({ handleCreateManualList }) => {
    return (
        <div className="text-center py-12 sm:py-20 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-blue-100 dark:border-blue-900/50">
            <div className="max-w-3xl mx-auto px-4">
                ...
                <Button 
                    ...
                    className="bg-green-600 hover:bg-green-700 text-white text-lg py-7 px-8 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
                    <DollarSign className="h-6 w-6 mr-3" />
                    Começar a Economizar Agora
                </Button>

                <div className="mt-10 flex justify-center space-x-6 text-gray-500 dark:text-gray-400">
